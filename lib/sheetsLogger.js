...
export async function logConversationRow({ body = {}, result = {}, options = {} }) {
  ...
  const payload = {
    ...
    ai_used: result._aiStatus?.used ? "yes" : "no",
    ai_tokens: result._aiStatus?.tokens || 0,
    hata: "",
    correct_reply: "",
    fix_layer: "",
    notes: "",
