...
export function smalltalkRule(ctx) {
  ...
  if (hasAny(norm, ["tesekkur","teşekkür","tesekur","teşekür","sagolun","sağolun","saol","tsk","tşk","rica ederim","sag olun","sag ol"])) return R("Rica ederiz efendim 😊");
  ...
  if (hasAny(norm, ["begendim","beğendim","begendik","beğendik","guzel","güzel","super","süper","harika","saglik","sağlık","bayildim","bayıldım","mukemmel","mükemmel"])) return R("Çok teşekkür ederiz efendim 😊");
